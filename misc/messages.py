...
1. Скачать из [Google Play](https://play.google.com/store/apps/details?id=com.wireguard.android) \
или [AppStore](https://apps.apple.com/ru/app/wireguard/id1441195209) приложение Wireguard.
2. Получите файл настроек для вашего VPN по команде /getvpn или кнопке "Получить VPN" в главном меню.
2. Скачать файл настроек, который можно получить \
командой /getsettings.
3. Открыть приложение и справа внизу нажать на "+"
4. Выбрать "Импорт из файла или архива"
5. Выбрать скачанный файл.
6. Передвинуть ползунок для активации приложения.
7. Использовать интернет как обычно.
